...
import BaseCard from "../../BaseCard"; // plasmic-import: XK1W0IOBqPChcQ/component
...
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: QHInDyDcOfMDyf/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box__iIyQ)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__zRubP)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box__quSmB)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__oiRUs)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet___7Dvj)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__tHes)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(defaultcss.all, sty.box__xfXjC)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <LinkButton
                  text={"Get started"}
