...
import * as sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: -VnSECV6NskiJ/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.box___8P0C9, {
            [sty.box__long___8P0C9APOwm]: hasVariant(variants, "long", "long")
          })}
        >
          <div
            className={classNames(defaultcss.all, sty.box__qCvD9, {
              [sty.box__long__qCvD9APOwm]: hasVariant(variants, "long", "long")
            })}
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(defaultcss.all, sty.svg__yyU51)}
                  role={"img"}
                />
              ),
      ...
      <div
        className={classNames(defaultcss.all, sty.box__peWhk, {
          [sty.box__long__peWhkaPOwm]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__iVuDn, {
            [sty.box__long__iVuDnaPOwm]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__lfT82)}
                role={"img"}
              />
            ),
