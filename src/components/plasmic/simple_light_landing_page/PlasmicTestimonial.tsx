...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: x3YVWLsy7XCV9F/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: 2rDYCjca1QBqsX/icon
import profilepic5BtafPc86DaPk from "./images/profilepic.png"; // plasmic-import: 5BtafPc86-DaPK/picture
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__aluwR)}
      >
        <div
