...
import * as sty from "./PlasmicTopSection.module.css"; // plasmic-import: No3qma38D5mCK/css

import heroImageVhN4E9I04Ubfla from "./images/heroImage.png"; // plasmic-import: VhN4E9i04Ubfla/picture
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__mlTmE)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box___0XlGq)}
        >
          <div className={classNames(defaultcss.all, sty.box__jccUa)}>
            <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__txfGy)}
        >
          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__mEx1C)}
            text={"Start free trial"}
            type={"solidBlue" as const}
          />

          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__s9HK3)}
            text={"Learn more"}
            type={"solidBlack" as const}
          />
        </p.Stack>

        <div className={classNames(defaultcss.all, sty.box__gVtik)}>
          <img
