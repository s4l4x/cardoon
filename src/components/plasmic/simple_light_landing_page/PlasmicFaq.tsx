...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: UfoRqlasL9IYt1/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__yjOkV)}
      >
        <div className={classNames(defaultcss.all, sty.box__ptjkz)}>
          <div className={classNames(defaultcss.all, sty.box__tXzG)}>
            {p.renderPlasmicSlot({
