...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: XK1W0IOBqPChcQ/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box__xoqwK, {
          [sty.box__long__xoqwKX86N]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__yiwEp, {
            [sty.box__long__yiwEpX86N]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__zrfSo)}
                role={"img"}
              />
            ),
