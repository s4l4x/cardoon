...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: R-SUhlZk9FMcA/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg__edsTu)}
              role={"img"}
            />
          ),
